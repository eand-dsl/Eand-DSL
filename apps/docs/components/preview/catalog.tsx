...
export const PAGES: Page[] = [
  ...
  { id: 'navbar', group: 'Components', title: 'NavBar', frame: 'phone',
    blurb: 'Floating glass bottom nav over a midnight scrim — one frosted pill of equal-width tabs. Active tab is a white pill with a red icon + label. Click a tab to move it.',
    controls: [
